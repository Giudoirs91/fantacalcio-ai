...
file_path = r'C:\Users\dorsi\.gemini\antigravity-ide\brain\a80fdade-57e7-4a13-bef6-e735ff50b036\.system_generated\steps\1123\content.md'
...
# Update database
update_team_injuries("Como", tm_players)
...
print()
print("=== CONTEGGIO INFORTUNI COMO 2025/2026 (SOLO GIOCATORI IN ROSA 26/27) ===")
print(f"Totale Calciatori in Rosa: {len(como_db)}")
print()

sorted_players = sorted(como_db.items(), key=lambda x: x[1]['partite_saltate'], reverse=True)
