...
function renderTable() {
    ...
    filtered.forEach(p => {
        try {
            ...
            // Titolarità (Scala Gerarchica: Viola 90-100%, Verde 75-89%, Arancione 50-74%, Grigio <50%, Rosso Infortunio)
            ...
            // Statistiche 2026/2027 Live con Tiers Dinamici (Viola -> Verde -> Arancione -> Grigio)
            ...
            // Statistiche Avanzate (Visuale Statistiche Avanzate - Tiers Coerenti)
